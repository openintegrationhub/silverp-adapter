...
async function processAction(msg, cfg) {
	...
	const self = this;
	const oihUid = (msg.meta !== undefined && msg.meta.oihUid !== undefined) ? msg.meta.oihUid : 'oihUid not set yut';
	const recordUid = (msg.data !== undefined && msg.data.recordUid !== undefined) ? msg.data.recordUid : 'recordUid not set yet';
