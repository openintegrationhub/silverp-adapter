...
const uri = 'http://yq.dyndns.org/SilvERP-OIH/index.php?rest&oih&rt=RestOih&command=upsertProduct';
	...
	async function emitData() {
		...
		*/
		...
		if (objectExists) {
			...
			delete reply.body.data.uid;
			newElement.meta = oihMeta;
			newElement.data = reply.body.data;
		}
		console.log("miau" + newElement);
