...
async function processAction(msg, cfg) {
	...
	const recordUid = (msg.body !== undefined && msg.body.recordUid !== undefined) ? msg.body.recordUid : undefined;
	...
	async function emitData() {
		...
		*/
		...
		personObject.context = msg.meta.shemaUri;
		// Upsert the object depending on 'objectExists' property
		const reply = await upsertObject(personObject, iamToken, objectExists, 'product', applicationUid);
